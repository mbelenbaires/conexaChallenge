...
public class VehicleController {
    ...
    @GetMapping()
    @Operation(summary = "Lista de vehículos", description = "Permite obtener de manera paginada los vehículos que forman parte de Star Wars, con su información correspondiente. " +
